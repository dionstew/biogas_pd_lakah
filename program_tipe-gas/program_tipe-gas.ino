...
// Variabel untuk menyimpan kadar gas
...
void loop() {
  ...
  if (now - lastMeasure > 30000) {
    ...
    client.publish("room/Methane", kmetStr.c_str());

    Serial.print("Kadar Metana: ");
    Serial.print(kmet);
    Serial.println("mol/cm3"); // Misalnya satuan kadar yang digunakan, tolong diganti jadi yang benar
  }
}
